...
if question:
    ...
    # Filter weak matches before sending context to the LLM.
    # You can tune this value after testing several questions.
    ...
    for doc, score in results_with_scores:
        ...
        # Keep at most one chunk from the same file and page.
    ...
    context = "\n\n".join(
        [
            f"Source {i + 1}, page "
            f"{doc.metadata.get('page_label', doc.metadata.get('page', 'Unknown'))}:\n"
            f"{doc.page_content}"
